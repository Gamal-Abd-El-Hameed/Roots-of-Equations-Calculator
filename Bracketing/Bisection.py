...
class Bisection(Bracketing):
    ...
    def solve(self, i: int) -> float or None:
        """
        Method to calculate an approximate root of a provided function using bisection
        ...
        # calculate x_middle by getting average of x values
        self.x_middle = self.converter.convert(self.converter.convert(self.x_lower + self.x_upper) / 2.0)
