...
class App(tk.Tk):
    ...
    def solve_equations(self):
        ...
        if not (self.method_selected.get() in root_finding_methods):
            ...
            i = len(equation_str) - 1
            while i != 0:
                if equation_str[i] in ('x', 's', 'e', 'c', '(') and ('0' <= equation_str[i - 1] <= '9' or equation_str[i - 1] in ('x', ')')):
                    equation_str = equation_str[0:i] + '*' + equation_str[i:]
                i = i - 1
        ...
        if self.method_selected.get() == "Gauss":
            ...
            try:
                bisection = Bisection(converter=float_converter, function=equation_str, rel_tolerance=eps,
                                      x_lower=float(self.x_lower.get()),
                                      x_upper=float(self.x_upper.get()),
                                      max_iterations=int(self.number_of_iterations.get()))
                ...
                error_window.title("Error!")
                l1 = ttk.Label(error_window, text=f"Error!", font=14)
                l2 = ttk.Label(error_window, text=f"f(Xl) * f(Xu) > 0 !", font=12)
                l1.pack()
                l2.pack()
                b1 = ttk.Button(error_window, text="OK", command=close_error)
                b1.pack()
                ...
                error_window.title("Error!")
                l1 = ttk.Label(error_window, text=f"Error!", font=14)
                l2 = ttk.Label(error_window, text=f"x value outside of function domain!", font=12)
                l1.pack()
                l2.pack()
                b1 = ttk.Button(error_window, text="OK", command=close_error)
                b1.pack()
            ...
            try:
                false_position = FalsePosition(converter=float_converter, function=equation_str, rel_tolerance=eps,
                                               x_lower=float(self.x_lower.get()),
                                               x_upper=float(self.x_upper.get()),
                                               max_iterations=int(self.number_of_iterations.get()))
            ...
            try:
                ...
                fixed_point = FixedPointIteration(equation, float(self.first_guess.get()), eps,
                                                  int(self.number_of_iterations.get()), float_converter)
                ...
                error_window.title("Error!")
                l1 = ttk.Label(error_window, text=f"Error!", font=14)
                l2 = ttk.Label(error_window, text=f"Change the initial guess!", font=12)
                l1.pack()
                l2.pack()
                b1 = ttk.Button(error_window, text="OK", command=close_error)
                b1.pack()
                ...
                error_window.title("Error!")
                l1 = ttk.Label(error_window, text=f"Error!", font=14)
                l2 = ttk.Label(error_window, text=f"Math Error", font=12)
                l1.pack()
                l2.pack()
                b1 = ttk.Button(error_window, text="OK", command=close_error)
                b1.pack()
                ...
                error_window.title("Error!")
                l1 = ttk.Label(error_window, text=f"Error!", font=14)
                l2 = ttk.Label(error_window, text=f"{err.__str__()}", font=12)
                l1.pack()
                l2.pack()
                b1 = ttk.Button(error_window, text="OK", command=close_error)
                b1.pack()
            ...
            try:
                x = symbols('x')
                equation = simplify(equation_str)
                newton_raphson = NewtonRaphson(equation, float(self.first_guess.get()),
                                               int(self.number_of_iterations.get()), eps, float_converter)
            ...
            try:
                x = symbols('x')
                equation = simplify(equation_str)
                secant = Secant(equation, float(self.first_guess.get()), float(self.second_guess.get()),
                                int(self.number_of_iterations.get()), eps, float_converter)
        ...
        if not (self.method_selected.get() in root_finding_methods):
            ...
            toolbar.update()
            canvas.get_tk_widget().pack()
            b1 = ttk.Button(plot_window, text="OK", command=close_plot)
            b1.pack()
